...
# Конвертация eps
find -regextype posix-extended $IMG/ -type f -name "*.eps" -exec epstopdf {} ";" ;
find -regextype posix-extended $IMG -type f -name "*.eps" -exec rm -f {} \;
...
# Clear
find -regextype posix-extended $TEX/ -maxdepth 1 -type f ! -regex ".*\.(tex|log|blg|bib|cls|sty|bst|clo|asm|gitignore)" -exec rm -f {} \; ;
