...
\begin{itemize}
    ...
    \end{item}
    \begin{item}
        \textbf{Архітектура:} SQL або NoSQL?
    \end{item}
    \begin{item}
...
\begin{itemize}
    \begin{item}
        \textbf{Back4app}
        \begin{itemize}
            \item Відкрите джерело
            \item Працює з базами даних SQL та NoSQL
            \item Масштабована інфраструктура
        \end{itemize}
    \end{item}
    \begin{item}
        ...
        \begin{itemize}
            \item Пропрієтарний
            \item Працює з базою даних NoSQL
            \item Масштабована інфраструктура
        \end{itemize}
    \end{item}
    \begin{item}
        ...
        \begin{itemize}
            \item Відкрите джерело
            \item Працює з базами даних SQL
            \item Масштабована інфраструктура
        \end{itemize}
    \end{item}
    \begin{item}
        ...
        \begin{itemize}
            \item Відкрите джерело
            \item Працює з реляційними базами даних
            \item Масштабована інфраструктура
        \end{itemize}
    \end{item}
    \begin{item}
...
// відкриваємо підключення до бази даних та робимо запит до таблиці
